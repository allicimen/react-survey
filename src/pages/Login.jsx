...
import { ArrowLeft, Mail, Lock, Sparkles, AlertCircle, LogIn } from "lucide-react";
      ...
      <div className="auth-left">
        ...
        <div className="auth-visual-content">
          ...
          <p className="visual-subtitle">
            ...
            Hemen giriş yapın ve akıllı analizlerin gücünü keşfedin.
          </p>
        </div>
      ...
      <div className="auth-right">
        <div className="form-container">
          ...
          <div className="form-header">
            <h2>Tekrar Hoş Geldiniz <LogIn size={24} style={{display:'inline', verticalAlign:'middle', marginLeft:'0.5rem', color:'var(--primary)'}}/></h2>
